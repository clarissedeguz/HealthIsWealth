...
class GenerateViewController: UIViewController, createDataDelegate {
    ...
    func createData() {
        ...
        "watermelon",
        "yellowtail fish"]
        let angiogenImage = [UIImage (named:"apple"), UIImage (named:"lemon"), UIImage (named:"watermelon"),UIImage(named:"cherry"),UIImage (named:"banana")]
        
        for (index,angioTitle) in angiogenName.enumerated() {
            let angiogenItem = Generate(category: "Angiogenesis", label: angioTitle,image: angiogenImage[index]!)
        ...
        "whole grains",
        "yellowtail (fish)"]
        let regenImage = [UIImage (named:"cola"), UIImage (named:"orange juice"), UIImage (named:"coffee"),UIImage (named:"wine"), UIImage (named: "milk")]
        
        for (index,regenTitle) in regenName.enumerated() {
            let regenItem = Generate(category: "Regeneration", label: regenTitle, image: regenImage[index]!)
        ...
        "whole grains",
        "yogurt"]
        let microbiImage = [UIImage (named: "popcorn"),UIImage (named: "donut"),UIImage (named: "popsicle"),UIImage (named:"lollipop"),UIImage (named:"fries")]
        
        for (index,microbiTitle) in microbiName.enumerated() {
            let microbiItem = Generate(category: "Microbiome", label: microbiTitle, image: microbiImage[index]!)
        ...
        "watermelon",
        "yellowtail (fish)"]
        let dnaItemImage = [UIImage (named:"steak"),UIImage (named: "sushi"),UIImage (named:"pizza"),UIImage(named: "udon"),UIImage (named:"pasta")]
        
        for (index, dnaItemTitle) in dnaItemName.enumerated() {
            let dnaItem = Generate(category: "DNA Protection", label: dnaItemTitle, image: dnaItemImage[index]!)
        ...
        "watercress",
        "white button mushrooms"]
        let immunImage = [UIImage (named:"carrot"),UIImage (named:"broccoli"),UIImage (named:"tomato"), UIImage (named:"potato"), UIImage (named:"eggplant")]
        
        for (index, immunTitle) in immunName.enumerated() {
            let immunItem = Generate(category: "Immunity", label: immunTitle, image: immunImage[index]!)
